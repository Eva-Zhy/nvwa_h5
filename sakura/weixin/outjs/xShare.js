(function($){
    ...
    var wxapi = "../view/jweixin-1.0.0.js", qqapi = "../view/qqapi.js";
    ...
    var wxManage={
        ...
        getTicket:function(callback){
            ...
            //console.log(window.gg.config.appid);

            $.ajax({
                //url: 'http://www.3dbizhi.com/platform/tool/weixin_share/jsticket.php',

                url: window.gg.config.projectUrl + '/yuepa/piapiapia/Server_Api/weixin_share/refreshticket.php',
                ...
                success: function (res) {
                    if (res) {
                        ...
                        require([wxapi], function () {
                            wx.config({
                                ...
                                timestamp: sig._timeStamp, // 必填，生成签名的时间戳
                                nonceStr: sig._nonceStr, // 必填，生成签名的随机串
                                signature: sig._signature, // 必填，签名，见附录1
                    ...
                    //else {
                    //    $.ajax({
                    //        url: 'http://case.h5tu.com/php/h5pagame/weixin_share/refreshticket.php',
                    //        type: 'get',
                    //        crossDomain: true,
                    //        dataType: 'jsonp',
                    //        jsonp: "callback",
